...
// NavACD standalone: FVector2i/FVector3i are provided by our shim
#ifndef NAVACD_INT_VECTOR_TYPES_PROVIDED
...
inline uint32 GetTypeHash(const FVector2i& Vector)
{
...
inline uint32 GetTypeHash(const FVector3i& Vector)
{
...
#endif // NAVACD_INT_VECTOR_TYPES_PROVIDED
