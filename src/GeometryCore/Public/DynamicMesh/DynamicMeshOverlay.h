...
public:
	 ...
	 * Note: Faster-but-equivalent-to calling CreateFromPredicate() with a CanShareVertex predicate that always returns true
	 * @param bExactMapIDs If true, ElementIDs will be constructed to exactly match the corresponding vertex IDs, even if the mesh is non-compact.
	 */
