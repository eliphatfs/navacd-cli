...
{
	// NavACD standalone: serialization is not supported
	// The original code references FUE5MainStreamObjectVersion and other UE types
	// that are not available in standalone builds.
}
