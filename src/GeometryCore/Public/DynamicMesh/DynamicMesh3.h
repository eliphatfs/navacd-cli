...
public:
	...
	GEOMETRYCORE_API FAxisAlignedBox3d GetBoundsForVertexSelection(TConstArrayView<int32> VertexIDs) const;

	/** Returns bounding box of all selected mesh triangles. Will use a chunked parallel implementation for larger selections. */
	GEOMETRYCORE_API FAxisAlignedBox3d GetBoundsForTriangleSelection(TConstArrayView<int32> TriangleIDs) const;
